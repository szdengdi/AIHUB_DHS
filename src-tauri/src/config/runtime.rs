...
/// 打包的 DeepSeek Harness(AIHub定制版) 发行版下载前缀：恒为 GitHub Release 官方直连，
...
/// 打包的 DeepSeek Harness(AIHub定制版) 发行版下载地址（GitHub 官方直连，首选源）
...
/// 指定 tag 的 DeepSeek Harness(AIHub定制版) 发行版下载地址。
///
